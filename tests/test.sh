...
echo "   --help       ...if man page style help opens."
echo "   --mouse-mode ...mouse mode enables/disables; audio playback,"
echo "                GNOME extension indicator icon changes."
...
echo "   --version    ...version metadata is displayed."
...
echo "   - On right click, indicator changes to mouse icon (teal); audio playback."
echo "   - On connect mouse (USB/Bluetooth) indicator changes to blue,"
echo "     and touchpad disabled; audio playback.."
echo "   - On disconnect mouse (USB/Bluetooth) indicator changes to teal,"
echo "     and touchpad enabled; audio playback."
echo "   - Indicator changes on left click to red, and touchpad disabled;"
echo "     audio playback."
echo
echo "   Press keyboard shortcut and observe..."
echo "   - Touchpad disabled/enabled and indicator changes icon and"
echo "     color; audio playback.."
